      ...
      <div className="grid lg:relative lg:grid-cols-2 min-h-screen">
        ...
        <div className="relative jakarta_medium order-1 lg:order-2 h-100 md:h-125 lg:h-auto 2xl:h-230">
          ...
          <div 
            ...
            className="absolute top-6 left-6 lg:top-20 lg:-left-10 lg:right-auto bg-white p-4 lg:py-6  rounded-xl shadow-2xl w-36 h-32 md:w-40 md:h-40   lg:w-64 lg:h-64  "
          >
