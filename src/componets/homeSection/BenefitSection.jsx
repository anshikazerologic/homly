...
export default function BenefitSection() {
  return (
    <>
      ...
      <section className="min-h-screen bg-[#100A55] text-white jakarta_medium py-16 px-4 md:px-15 lg:px-20 2xl:px-40 3xl:px-60 flex flex-col justify-center overflow-hidden">
